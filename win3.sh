...
########################### nodae
# -------------------------------- H1 --------------------------------
python main.py --seq_path data/dataset0722/H1N1_N2_HA_syed.csv --anti_path data/dataset0722/H1N1_N2_HI_syed.csv --subtype H1 --label NHT_distance --valid_type titer --n_jobs 30  --low none --ae_dim 566 --epoch 20 --model full --im_lambda 3e-5 --im_epoch 10 --device cuda:5

# -------------------------------- H3 --------------------------------
python main.py --seq_path data/dataset0722/H3N2_full_HA_syed.csv --anti_path data/dataset0722/H3N2_full_HI_syed.csv --subtype H3 --label NHT_distance --valid_type titer --n_jobs 30  --low none --ae_dim 566 --epoch 20 --model full --im_lambda 3e-5 --im_epoch 10 --device cuda:5

# -------------------------------- H5 --------------------------------
python main.py --seq_path data/dataset0722/H5_HA_syed.csv --anti_path data/dataset0722/H5_HI_syed.csv --subtype H5 --label NHT_distance --valid_type titer --n_jobs 30  --low none --ae_dim 566  --epoch 300 --model full --im_lambda 5e-5 --im_epoch 25 --device cuda:5 